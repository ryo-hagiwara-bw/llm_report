...
@dataclass
class SimpleFunctionCallingRequest:
...
@dataclass
class SimpleFunctionCallingResponse:
...
class SimpleFunctionCallingUseCase:
    ...
    async def execute(self, request: SimpleFunctionCallingRequest) -> SimpleFunctionCallingResponse:
        ...
        try:
            ...
            return SimpleFunctionCallingResponse(
                content=content,
