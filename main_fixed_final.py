...
from src.llm_report.application.use_cases.simple_function_calling_use_case import SimpleFunctionCallingUseCase, SimpleFunctionCallingRequest
...
class FixedFinalLLMApp:
    ...
    async def generate_with_functions(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            request = SimpleFunctionCallingRequest(prompt=prompt)
            
            use_case = SimpleFunctionCallingUseCase(
                self.container.get_llm_repository(),
